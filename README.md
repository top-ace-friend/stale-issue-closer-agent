...
This repository now vendors the Agent Inbox UI as a git submodule at `agent-inbox` (tracking the `ui-improve` branch of <https://github.com/langchain-ai/agent-inbox>).
